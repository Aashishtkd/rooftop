...
<div class="card">
    <div class="card-body">
        <a class="btn btn-success" href="{{ route('admin.others.tform' ,['mode'=>'add']) }}">Add New Testimonials</a>
...
$(document).ready(function(){
    ...
    $("#datatable").on('click','.btnDelete',function(){
          ...
          if (result.isConfirmed) {
              $.ajax({
                  url: "{{ route('admin.others.tdestroy') }}",
                  type : "POST",
                  cache:false,
      ...
      var table = $('.yajra-datatables').DataTable({
          ...
          ajax: "{{ route('admin.others.tloadtable') }}",
          columns: [
